...
> The gold standard for x402 resources. **450 curated entries** — every one checked by hand before it was listed. No filler. No dead links.
...
The product. 450 entries across 13 shelves, in [`directory/`](directory/).
