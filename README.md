...
> The gold standard for x402 resources. **451 curated entries** — every one checked by hand before it was listed. No filler. No dead links.
...
The product. 451 entries across 13 shelves, in [`directory/`](directory/).
