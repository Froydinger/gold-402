...
> The gold standard for x402 resources. **463 curated entries** — every one checked by hand before it was listed. No filler. No dead links.
...
The product. 463 entries across 12 shelves, in [`directory/`](directory/).
