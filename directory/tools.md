...
- [mcpc](https://github.com/apify/mcpc) [![Open Source](https://img.shields.io/badge/Open_Source-2EA44F?style=plastic)](https://github.com/apify/mcpc) — Universal CLI client for MCP by Apify. Supports persistent sessions, stdio/HTTP, OAuth, and x402 micropayments. The `curl` for MCP. 679★
- [portal-tunnel](https://github.com/gosuda/portal-tunnel) [![Open Source](https://img.shields.io/badge/Open_Source-2EA44F?style=plastic)](https://github.com/gosuda/portal-tunnel) — Publishes localhost services to the agentic web through self-hostable, trustless tunnels with x402 payment gating. 260★
- [x402-payment-link](https://github.com/second-state/x402-payment-link) [![Open Source](https://img.shields.io/badge/Open_Source-2EA44F?style=plastic)](https://github.com/second-state/x402-payment-link) — Generate shareable x402 payment links. Pay-per-access URLs for content, APIs, and digital goods. 201★
- [tweazy](https://github.com/aaronjmars/tweazy) [![Open Source](https://img.shields.io/badge/Open_Source-2EA44F?style=plastic)](https://github.com/aaronjmars/tweazy) — Monetize AI applications and MCP servers using x402, CDP Smart Wallets, and Coinbase AgentKit. Quick scaffolding for payment-gated tools. 47★
