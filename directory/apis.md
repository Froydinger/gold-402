...
- [Zugabot Image Generation](https://zugabot.ai/x402#image-generation) — Text-to-image generation via x402: FLUX Schnell ($0.15) or FLUX 2 Pro ($0.50), returns image URL plus dimensions and seed. USDC on Base.
